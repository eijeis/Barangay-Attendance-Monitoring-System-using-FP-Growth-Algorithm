namespace BAMS.UserControls
{
    partial class UserListUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvUser.Columns.AddRange(new DataGridViewColumn[] { colEmployeeID, colFullName, colGender, colPosition, colAction });
            ...
            colEmployeeID.DefaultCellStyle = dataGridViewCellStyle2;
            colEmployeeID.FillWeight = 25.9245815F;
            colEmployeeID.HeaderText = "EmployeeID";
            colEmployeeID.MinimumWidth = 120;
            ...
            panelSearchCard.Paint += panelSearchCard_Paint;
            // 
            // btnAddUser
            // 
