namespace BAMS.UserControls
{
    partial class FpGrowthUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            // txtSearchFullName
            // 
            txtSearchFullName.BackColor = Color.White;
            txtSearchFullName.BorderStyle = BorderStyle.FixedSingle;
            txtSearchFullName.Font = new Font("Segoe UI", 10F);
            txtSearchFullName.Location = new Point(43, 46);
            txtSearchFullName.Name = "txtSearchFullName";
            txtSearchFullName.Size = new Size(378, 25);
            txtSearchFullName.TabIndex = 5;
            txtSearchFullName.Text = "Search Full Name";
            txtSearchFullName.TextChanged += txtSearchFullName_TextChanged;
            // 
            // button1
            // 
